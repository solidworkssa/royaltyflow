# 13-royaltyflow - Base Native Architecture
...
Creator royalty distribution system

## Overview

Royaltyflow provides a decentralized solution for automated payment splits for creators on both Base (EVM) and Stacks blockchains.
